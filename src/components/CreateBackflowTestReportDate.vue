...
export default {
    ...
    methods: {
        getBackflowAssemblies(){
            if(this.date){
                this.$http.get('/backflow_assemblies?includes=backflow_size,backflow_type,backflow_manufacturer,backflow_model,backflow_super_type,backflow_type.backflow_super_type.backflow_valves,backflow_test_reports,backflow_test_reports.backflow_tests,property&active=true&test_date=' + this.date).then(response => {
