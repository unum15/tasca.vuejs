<template>
	<div>
        <b-tabs>
            ...
            <b-tab title="Tasks">
                <EditTasks :order="work_order" order_type="work_order" :task_types="task_types" :task_categories="task_categories" :task_statuses="task_statuses" :task_actions="task_actions"></EditTasks>
            </b-tab>
            <b-tab title="Notes">
        ...
        <b-button variant="danger" size="sm" @click="deleteWorkOrder()">Delete Work Order</b-button>
	</div>
</template>
<script>
...
export default {
	...
	created() {
        this.my_work_order = this.work_order;
    },
	methods: {
